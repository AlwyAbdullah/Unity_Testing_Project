        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h2 class="form-title text-gray-800">Update Kategori</h2>
                    <?php if (isset($validation)) : ?>
                        <div class="alert alert-danger"><?= $validation->listErrors() ?></div>
                    <?php endif; ?>
                    <form method="POST" class="register-form" id="register-form" action="<?= base_url('Home/updateKategori/' . $kategori->id_kategori); ?>">
                        <div class="form-group">
                            <!-- <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label> -->
                            <input type="text" name="nama_kategori" id="nama_kategori" placeholder="Nama Kategori" required class="form-control" value="<?= $kategori->nama_kategori ?>"/>
                        </div>
                        <div class="form-group form-button">
                            <input type="submit" name="submit" id="submit" class="form-submit btn btn-primary" value="Save" />
                        </div>
                    </form>
                    <!-- DataTales Example -->
